...
| [007](007-experimental-eval/) | Experimental evaluation | in-progress (primary metrics + 4-arm harness + ablation + latency + paper done; DAGRD rubric + CI pending) | `tests/test_evaluation_primary_metrics.py`, `tests/test_evaluation_run.py`, `tests/test_evaluation_ablation.py`, `tests/test_evaluation_latency.py`, `tests/test_reproduce_paper.py` |
