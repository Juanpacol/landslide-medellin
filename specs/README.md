...
| [004](004-explanations/) | Explanations (XAI) | done for production path (deterministic, no-LLM); SHAP + frontend panel pending | `tests/test_explain_render.py`, `tests/test_generate_explanation_from_verdict.py` |
